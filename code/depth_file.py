...
def usageExample():
    ...
    depths, depths_matches = readPileup(pileup_file)

    mmDepth = modeOfModes(depths)     # list
    maxDepth = maxMode(depths)         # list
    maxMedDepth = maxMedian(depths)    # int
    
    mmDepth2 = modeOfModes(depths_matches)     # list
    maxDepth2 = maxMode(depths_matches)         # list
    maxMedDepth2 = maxMedian(depths_matches)    # int
